...
def cap(s):
    isWord = s != '' and all(chr.isalpha() or chr.isspace() for chr in s)
    if isWord:
        return s.capitalize()
    return s
    ...
    def __init__(
        ...
        self.workspaces = Workspaces(
            ...
            buttons_list=[
                ...
                WorkspaceButton(label=FormattedString("8")),
                WorkspaceButton(label=FormattedString("9")),
                WorkspaceButton(label=FormattedString("0")),
